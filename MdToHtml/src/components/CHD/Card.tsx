...
import { Maximize2, Palette, MoreHorizontal, LayoutGrid, Type, ArrowLeft, ArrowRight, ArrowUp, ArrowDown, Edit, Check, Trash2, Minus, Plus, AlignLeft, AlignCenter, AlignRight, Send, AlertCircle, Activity, GitBranch, BookOpen, HardDrive } from 'lucide-react';
import { getShapeClass, CardShape } from '../../lib/shapes';
import { getIconComponent, iconExists } from '../../lib/icon-manager';
...
export const Card: React.FC<CardProps> = ({ 
  ...
  // 获取图标组件（同步版本）
  const getIconComponentSync = (iconName: string): React.ElementType | null => {
    try {
      // 这里使用一个简化的同步映射，实际项目中可能需要更复杂的处理
      // 对于生产环境，建议预加载所有可能的图标
      const iconMap: Record<string, React.ElementType> = {
        // 基础图标
        zap: require('lucide-react').Zap,
        cpu: require('lucide-react').Cpu,
        chart: require('lucide-react').BarChart2,
        chart3: require('lucide-react').BarChart3,
        ...
        message: require('lucide-react').MessageSquare,
        ...
        dollar: require('lucide-react').DollarSign,
        ...
        filecode: require('lucide-react').FileCode,
        fileimage: require('lucide-react').FileImage,
        filevideo: require('lucide-react').FileVideo,
        fileaudio: require('lucide-react').FileAudio,
        filespreadsheet: require('lucide-react').FileSpreadsheet,
        filearchive: require('lucide-react').FileArchive,
        ...
        tablet: require('lucide-react').Tablet,
        terminal: require('lucide-react').Terminal,
        ...
        // 新增图标
        signal: require('lucide-react').WifiOff,
        refresh: require('lucide-react').RefreshCw,
        timer: require('lucide-react').Clock4,
        history: require('lucide-react').History,
        phone: require('lucide-react').Smartphone,
        index: require('lucide-react').Hash,
        memory: require('lucide-react').Database,
        tree: require('lucide-react').TreePine,
        controller: require('lucide-react').Cpu,
        service: require('lucide-react').Server,
        data: require('lucide-react').Database,
        spring: require('lucide-react').Leaf,
        storage: require('lucide-react').HardDrive,
        mobile: require('lucide-react').Smartphone,
        expand: require('lucide-react').Maximize2,
        edge: require('lucide-react').Wifi,
        // 微信小程序文档中使用的图标
        tool: require('lucide-react').PenTool,
        'pen-tool': require('lucide-react').PenTool,
        ...
        'book-open': BookOpen,
        // 缓存系统分析与优化报告使用的图标
        workflow: require('lucide-react').GitBranch,
        'check-circle': require('lucide-react').CheckCircle,
        wrench: require('lucide-react').Settings,
        puzzle: require('lucide-react').Layers,
        scan: require('lucide-react').Search,
  ...
  return (
    ...
    >
      ...
      <div className={clsx(
        ...
        attributes.icon && getIconComponentSync(attributes.icon) && shape === 'rect' && "pl-14", // 当有图标时，增加左侧padding
