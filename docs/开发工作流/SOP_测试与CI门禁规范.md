...
| [`plans/测试工程/02_测试现状实测与剩余任务计划_2026-09-14.md`](../../plans/测试工程/02_测试现状实测与剩余任务计划_2026-09-14.md) | 当日实测基线（覆盖率三口径、E2E 现状、CI run #1/#2）+ 剩余任务 A/B/C/D 分解 |
| [`docs/开发工作流/GitHub流水线配置指南.md`](GitHub流水线配置指南.md) | **现役平台**：GitHub Actions 三条流水线的触发规则、门禁对应、发布流程与排错 |
